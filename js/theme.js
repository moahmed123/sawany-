...
if ($("nav").hasClass("navbar-single-page")) rt.on("click", function() {
...
n = ['<span class="icon icon-chevron-left"><\/span>', '<span class="icon icon-chevron-right"><\/span>'];
...
d = $(".wrapper");
d.append($("<div class='scroll-top'><i class='icon icon-chevron-up'><\/i><\/div>"));
t = $(".scroll-top");
...
if ($("nav").hasClass("navbar-single-page")) {
    a = $(".navigation-main a");
    a.on("click", function() {
        return a.removeClass("current"), $(this).addClass("current"), $("html, body").animate({
...
if (setTimeout(function() {
    ...
    function n() {
        ...
        $(".tabsy-wrapper-intro .tabsy figure").css("height", $(window).height() - n - t)
    }
}
});